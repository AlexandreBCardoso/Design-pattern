...
class QuotesViewController: UIViewController, Storyboardable {
	...
	private let quotes: [Quote] = [
		...
		Quote(
            author: "Jane Goodall",
            content: "Every individual matters. Every individual has a role to play. Every individual makes a difference."
        ),
		Quote(
            author: "Dalai Lama",
		...
		Quote(
            ...
            content: "Science and everyday life cannot and should not be separated."
        ),
		Quote(
